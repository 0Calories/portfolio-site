...
const jobs = [
  {
    ...
    description:
      "During my time at Cheetah Networks, I contributed to the development of a system for preventing distracted driving. I was responsible for writing code for an Android application, as well as the firmware of a custom Bluetooth device. I facilitated the core Bluetooth features of the system by designing and implementing the wireless communication system between the application and custom device. I was also responsible for the creation and management of the source code repository, and made various additions and bugfixes to the software.",
    badges: ["C++", "Java"],
  },
  {
    company: "Cision",
  ...
  },
  {
    ...
    description:
      "During this work-term, I created new features for the UI of the 'OverDrive' software, as well as migrated the UI software platform to the latest version.",
  ...
  },
  {
    ...
    description:
      "During the Summer, I created a dashboard tool from scratch for monitoring the status of various server computers in the IT branch. I also worked part-time for the HR department after my placement; I managed and developed new features for their SharePoint site.",
    badges: ["Java", "JavaScript", "HTML5", "CSS3"],
  },
];
...
const WorkSection = (props) => (
  <div className="section" id="work-section">
    <Flip left>
      <h1 id="work-section__header" className="section__header">
        {props.sectionName}
      </h1>
    </Flip>
